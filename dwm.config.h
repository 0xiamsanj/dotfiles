...
static char *fonts[]          = { "Cascadia Code PL:size=12:antialias=true", "NotoColorEmoji:pixelsize=10:antialias=true:autohint=true"  };
...
static const Key keys[] = {
	...
	{ MODKEY,			XK_r,		spawn,		{.v = (const char*[]){ TERMINAL, "-e", "thunar", NULL } } },
